...
aut aut aut maxime quia temporibus ut omnis`}],Nc=({comment:e})=>B.jsxs("div",{className:"CommentInfo",children:[B.jsxs("div",{className:"CommentInfo__title",children:[B.jsx("strong",{className:"CommentInfo__name",children:e.name})," by ",B.jsx("a",{className:"CommentInfo__email",href:`mailto:${e.email}`,children:e.email})]}),B.jsx("div",{className:"CommentInfo__body",children:e.body})]}),Pc=({comments:e})=>e.length===0?B.jsx("b",{"data-cy":"NoCommentsMessage",children:"No comments yet"}):B.jsx("div",{className:"CommentList",children:e.map(t=>B.jsx(Nc,{comment:t},t.id))}),Lc=({user:e})=>B.jsx("a",{className:"UserInfo",href:`mailto:${e.email}`,children:e.name}),Tc=({post:e})=>B.jsxs("div",{className:"PostInfo",children:[B.jsxs("div",{className:"PostInfo__header",children:[B.jsx("h3",{className:"PostInfo__title",children:e.title}),B.jsxs("p",{children:[" Posted by  ",B.jsx(Lc,{user:e.user})]})]}),B.jsx("p",{className:"PostInfo__body",children:e.body}),B.jsx("hr",{}),B.jsx(Pc,{comments:e.comments})]}),Mc=({posts:e})=>B.jsx("div",{className:"PostList",children:e.map(t=>B.jsx(Tc,{post:t},t.id))}),Rc=[{id:1,name:"Leanne Graham",username:"Bret",email:"Sincere@april.biz"},{id:2,name:"Ervin Howell",username:"Antonette",email:"Shanna@melissa.tv"},{id:3,name:"Clementine Bauch",username:"Samantha",email:"Nathan@yesenia.net"},{id:4,name:"Patricia Lebsack",username:"Karianne",email:"Julianne.OConner@kory.org"},{id:5,name:"Chelsey Dietrich",username:"Kamren",email:"Lucio_Hettinger@annie.ca"},{id:6,name:"Mrs. Dennis Schulist",username:"Leopoldo_Corkery",email:"Karley_Dach@jasper.info"},{id:7,name:"Kurtis Weissnat",username:"Elwyn.Skiles",email:"Telly.Hoeger@billy.biz"},{id:8,name:"Nicholas Runolfsdottir V",username:"Maxime_Nienow",email:"Sherwood@rosamond.me"},{id:9,name:"Glenna Reichert",username:"Delphine",email:"Chaim_McDermott@dana.io"},{id:10,name:"Clementina DuBuque",username:"Moriah.Stanton",email:"Rey.Padberg@karina.biz"}];function Dc(e){return Rc.find(t=>t.id===e)||null}function jc(e){return zc.filter(t=>t.postId===e)}const Oc=Cc.map(e=>({...e,user:Dc(e.userId),comments:jc(e.id)})),Fc=()=>B.jsx("section",{className:"App",children:B.jsx(Mc,{posts:Oc})});em(document.getElementById("root")).render(B.jsx(Fc,{}));
